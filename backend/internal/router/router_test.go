...
func buildRouterForTest(t *testing.T, subPath string) http.Handler {
	...
	return Build(nil, authSvc, nodesSvc, hostsSvc, inboundsSvc, subscriptionSvc, usersSvc, panelCfgSvc, auditsSvc, plansSvc, nil /* bootstrapSvc */, nil /* backupsSvc */, nil /* webhooksSvc */, nil)
}
