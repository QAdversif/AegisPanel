...
- Why multi-tenant was rejected.
- Why the CoreProvider abstraction is a hard contract.
- Why subscription rendering is on the hot path.
- Why decoy sites and a secret admin path are first-class concerns.
