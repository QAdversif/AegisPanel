...
of age, body size, visible or invisible disability, ethnic
characteristics, sex characteristics, gender identity and expression,
...
repository, issue tracker, discussions, pull requests, and any other
channel where the project is represented. It also applies when an
individual is representing the project in public spaces (using an
...
may be reported to the project maintainers via the private channel
